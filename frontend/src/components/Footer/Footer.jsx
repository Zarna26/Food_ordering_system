    ...
    <div className='footer' id='footer'>
        <div className="footer-content">
            <div className="footer-content-left">
                <p className='text'>Tasty Bites</p>
            ...
            <div className="footer-content-center">
                <h2>Company</h2>
                <ul>
                <a href="https://www.tastybite.co.in/ourstory#oHistory" target="_blank" rel="noopener noreferrer">

                
                    <li>Home</li>
                    </a>

                 <a href="https://www.tastybite.co.in/ourstory#oMission" target="_blank" rel="noopener noreferrer">
                    <li>About us</li>
                    </a>
                    <li>Delivery</li>
        ...
        <hr/>
        <p className='footer-copyright'><b>CopyRight 2024 @ TastyBites - All Right Reserved. </b></p>
